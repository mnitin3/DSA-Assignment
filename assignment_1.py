class Trains():
   ...
   def showAll(self):
       lines=self.readCity("inputPS4.txt")
       T_no=[]
       T_names=[]
       All_dup_names=[]
       for line in lines:
   ...
   def findServiceAvailable(self,city_a,city_b):
       ...
       print("City B:",city_b)
       lines=self.readCity("inputPS4.txt")
       # direct=self.displayDireactTrain(city_a,city_b)
       # if direct:
       #    print(direct)
       list=[]
       for line in lines:
